...
# text
draw.text(js_box_width/2-100, int(window_height/12), "A, B, C, D, E", color="black", size=20, max_width=None)
draw.text(js_box_width/2-100, int(window_height*11/12), "L, M, N, O, P", color="black", size=20, max_width=None)
draw.text(int(js_box_width/12), int(window_height/2), "A, B, C, D, E", color="black", size=20, max_width=None)
draw.text(int(js_box_width*11/12), int(window_height/2), "L, M, N, O, P", color="black", size=20, max_width=None)
# joystick oval
